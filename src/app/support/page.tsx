      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            ...
            {/* Column 1: Bank Transfer */}
            <div className="bg-navy-800 text-white rounded-3xl p-8 md:p-10 shadow-lg relative overflow-hidden flex flex-col justify-between select-none">
            ...
            {/* Column 2: Partnership */}
            <div className="bg-gray-50 border border-gray-200 rounded-3xl p-8 md:p-10 shadow-sm flex flex-col justify-between">
              <div>
              ...
              <div>
                <a
                  href={`mailto:${contactDetails.email}`}
                  className="inline-flex items-center justify-center w-full py-4 rounded-xl bg-red-600 hover:bg-red-700 text-white font-display font-bold text-[14.5px] tracking-wider uppercase text-center shadow-md transition-colors cursor-pointer"
                >
                  Email Us to Partner
                </a>
              </div>
